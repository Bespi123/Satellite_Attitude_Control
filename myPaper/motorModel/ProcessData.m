...
%%OBTAINING DATA
V=step1(130:430,1)'*20/255; %Applied voltaje
W=60*step1(130:430,2)'/(6*0.2)*(2*pi/60); %Reaction wheel angular rate
i=10^(-3)*step1(130:430,3)'; %Brushless motor current 
